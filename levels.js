const levels = [
  // --- SECCIÓN: TUTORIAL (Fundamentos guiados) ---
  {
    difficulty: "Tutorial",
  ...
  // --- SECCIÓN: FÁCIL (Relaciones en el DOM) ---
  {
    difficulty: "Fácil",
  ...
  // --- SECCIÓN: INTERMEDIO (Atributos y Pseudo-clases) ---
  {
  ...
  },
  {
    ...
    targetSelector: 'team :first-child'
  },
  {
    difficulty: "Intermedio",
    ...
    targetSelector: 'box pokemon:nth-child(odd)'
  },

  // --- SECCIÓN: DIFÍCIL (Selectores avanzados) ---
  {
    difficulty: "Difícil",
    ...
    targetSelector: 'pokemon[tier="legendary"]:not([type="psychic"])'
  },
  {
    difficulty: "Difícil",
    ...
    targetSelector: 'pokemon[pokedex="150"] ~ pokemon'
  }
];